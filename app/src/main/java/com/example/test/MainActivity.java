...
public class MainActivity extends AppCompatActivity {
    ...
    /*
    Метод вызываемый при создании активности MainActivity
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //инициализаци интента,который ведёт к антивности Main2Activity
        intent = new Intent(MainActivity.this, Main2Activity.class);

        //получение значения, передающегося от активности Main2Activity
        ...
        switch(view.getId()) {
            ...
            case R.id.joinButton:
                ...
                if(login.getText().toString().equals(LoginForChecking) && pass.getText().toString().equals(PasswordForChecking)) {
                     ...
                     *обнуляем переменную, сохраняем логин и пароль и вызываем активность Main2Activity,
                     *в другом случае просто переходим на активность Main2Activity*/
                    if(RememberCheckBox.isChecked()) {
                        //обнуляем переменную в которой хранится значение полученное из Main2Activity
                        Quit = 0;
                        ...
                        //вызываем активность Main2Activity
    ...
    protected void onResume(){
        ...
        /*Если было передано из Main2Activity значение 1, то
        ...
        if(sh.contains(sh_login) && sh.contains(sh_pas)) {
            ...
            if(s1.equals("admin") && s2.equals("admin"))
                //вызов активности Main2Activity
                startActivity(intent);
        }
    }
